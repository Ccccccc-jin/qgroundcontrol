...
#ifndef WiFiSetupComponent_H
#define WiFiSetupComponent_H

#include "VehicleComponent.h"

class WiFiSetupComponent : public VehicleComponent
{
    Q_OBJECT
public:
    WiFiSetupComponent            (Vehicle* vehicle, AutoPilotPlugin* autopilot, QObject* parent = NULL);
