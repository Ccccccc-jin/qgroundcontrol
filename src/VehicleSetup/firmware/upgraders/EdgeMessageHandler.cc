...
EdgeMessageHandler::EdgeMessageHandler(QObject *parent)
    : QObject(parent)
{  }


void EdgeMessageHandler::onRpiBootStateChanged(uint state, uint type)
{
...
void EdgeMessageHandler::onDeviceScannerStateChanged(uint state, uint type)
{
...
void EdgeMessageHandler::onFlasherStateChanged(uint state, uint type)
{
...
MessageSignal_t
    EdgeMessageHandler::_getMessageSignal(uint messageType)
{
